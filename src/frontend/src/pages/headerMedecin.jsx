...
<Navbar style={{ backgroundColor: '#4dd869', width: '100vw' }} fixed="top">
    <Navbar.Brand href="MedecinHome" onClick={MedecinHome} style={{ fontSize: '30px', fontWeight: 'bold' }}>
      MT Hospital
    </Navbar.Brand>
    <Navbar.Toggle aria-controls="basic-navbar-nav" />
    <Navbar.Collapse id="basic-navbar-nav">
      <Nav className="ml-auto d-flex align-items-center">
        <Nav.Link  onClick={MedecinHome} style={{ fontWeight: 'bold', marginLeft: '20px' }}>
        ...
        <Nav.Link href="MedecinAccount" onClick={MedecinAccount} style={{ fontWeight: 'bold', marginLeft: '20px' }}>
          <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="currentColor" className="bi bi-person-circle" viewBox="0 0 16 16">
            <path d="M11 6a3 3 0 1 1-6 0 3 3 0 0 1 6 0"/>
            <path fillRule="evenodd" d="M0 8a8 8 0 1 1 16 0A8 8 0 0 1 0 8m8-7a7 7 0 0 0-5.468 11.37C3.242 11.226 4.805 10 8 10s4.757 1.225 5.468 2.37A7 7 0 0 0 8 1"/>
          </svg>
        </Nav.Link>
        <Nav.Link href="MedecinPatients"  onClick={MedecinPatients}  style={{ fontWeight: 'bold', marginLeft: '20px' }}>
        ...
        <Nav.Link href="MedecinLogin" onClick={logOut} style={{ fontWeight: 'bold', marginLeft: '20px' }}>
